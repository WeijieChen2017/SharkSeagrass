...
def main():
    ...
    wandb_config = {
        ...
        "model_scale": args.model_scale,
        "batch_size": args.batch_size,
        "SSL_available": args.SSL_available,
        "model_architecture": model_architecture,
    ...
    wandb_run.log_code(root=".", name=tag+"T5_v1_train.py")
    ...
    for idx_epoch in range(train_params["num_epoch"]):
        ...
        if idx_epoch % train_params["val_per_epoch"] == 0:
            ...
            if val_norm_loss < best_val_loss:
                ...
                wandb_run.log_model(path=save_path, name="model_best_eval", aliases=tag+f"cv{cross_validation}_{tag}")
        ...
        if idx_epoch % train_params["save_per_epoch"] == 0:
            ...
            wandb_run.log_model(path=save_path, name="model_checkpoint", aliases=tag+f"cv{cross_validation}_{tag}")
